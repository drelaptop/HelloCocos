...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if (!glview) {
        ...
        glview = GLViewImpl::createWithRect("HelloTest2", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("HelloTest2");
#endif
    ...
    sceneManager->createLoadScene();
    director->runWithScene(sceneManager->loadScene);
